...
public class Complexutil {
	...
	public static ComplexNumber[] reverise(ComplexNumber[] a) {
	...
	// sets each spot of the array to a random values baised on the max value in the
	// main array
	...
	public static ComplexNumber Theromax() {
		return new ComplexNumber(100, 0);
	}
